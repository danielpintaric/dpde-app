...
const previewFrame =
  "relative aspect-[16/10] w-full max-w-md overflow-hidden rounded-md border border-zinc-800/80 bg-zinc-900/40";
...
const fileInputClass =
  "block w-full max-w-md cursor-pointer text-[11px] text-zinc-400 file:mr-3 file:cursor-pointer file:rounded file:border file:border-zinc-600 file:bg-zinc-800/80 file:px-2.5 file:py-1 file:text-[11px] file:font-medium file:text-zinc-200 hover:file:border-zinc-500";
const ghostBtn =
...
export function SiteHeroImageSlots({ initial1, initial2, initial3 }: Props) {
  ...
  const upload = async (slot: 1 | 2 | 3, file: File) => {
  ...
  const slots: { slot: 1 | 2 | 3; label: string; i: SlotIndex }[] = [
