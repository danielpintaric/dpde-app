...
const leadImageLgTrio =
  "relative aspect-[4/5] w-full overflow-hidden sm:aspect-[16/10] md:aspect-[16/11] lg:aspect-[2/1] lg:min-h-[min(58vh,46rem)]";

/** Support: ruhiges 3:4, Höhe aus Ratio — keine flex-1-/h-full-Kette. */
          ...
          <div className="mt-7 grid grid-cols-1 gap-8 md:mt-10 md:gap-9 lg:mt-11 lg:grid-cols-[minmax(0,1fr)_minmax(12.5rem,31%)] lg:items-start lg:gap-x-11 xl:gap-x-12">
            <div className="min-w-0">
              <FeaturedTileLead
                ...
                category={lead.category}
                sizes="(min-width: 1024px) 62vw, 92vw"
                imageWrapperClassName={leadImageLgTrio}
              />
            </div>
